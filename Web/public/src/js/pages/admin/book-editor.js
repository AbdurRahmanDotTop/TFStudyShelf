...
const AdminBookEditor = (() => {
  ...
  exports.openQnAModal = function() {
    ...
    `, async () => {
      ...
      try {
        await ApiClient.admin.createQuestion(editingBookId, { question: q, answer: a });
  ...
  async function loadFormData(isEdit) {
    ...
    if (isEdit) {
      try {
        ...
        document.getElementById('book-read-time').value = book.estimatedReadTimeMinutes || '';
        document.getElementById('book-rights-status').value = book.rightsStatus || 'RESTRICTED';
        document.getElementById('book-license-name').value = book.licenseName || '';
        document.getElementById('book-license-source').value = book.licenseSource || '';
        document.getElementById('book-rights-holder').value = book.rightsHolder || '';
        document.getElementById('book-permission-ref').value = book.permissionReference || '';
        document.getElementById('book-allow-download').checked = !!book.allowedDownload;
        document.getElementById('book-allow-offline').checked = !!book.allowedOffline;
        document.getElementById('book-allow-share').checked = !!book.allowedShare;
        document.getElementById('book-pdf-drive-id').value = book.pdfGoogleDriveId || '';
        ...
        document.getElementById('book-is-featured').checked = book.featuredOrder != null;
